...
load_plugins {
  ...
  -- { 'axelvc/template-string.nvim', event = 'VeryLazy', opts = { remove_template_string = true } },
  ...
  { 'inkarkat/vim-visualrepeat', event = 'VeryLazy' },
  ...
  { 'andymass/vim-matchup', event = 'VeryLazy', config = true },
